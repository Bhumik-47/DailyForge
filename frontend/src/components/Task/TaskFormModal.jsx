...
const TAG_MAX_LENGTH = 15; // Your validation constraint
...
export default function TaskFormModal({
  ...
  const [dueTime, setDueTime] = useState(""); // Merged from main branch
              ...
              {showOtherInput && (
                <div className="mt-2 flex gap-2">
                  <input
                    ...
                    maxLength={TAG_MAX_LENGTH} // Your length fix correctly applied here
